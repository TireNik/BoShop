...
public class UserCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5792260761957709791L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserCreatedEvent\",\"namespace\":\"com.kika.avro\",\"fields\":[{\"name\":\"userId\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"}]}");
   ...
   */
  public UserCreatedEvent(java.lang.Long userId, java.lang.CharSequence name, java.lang.CharSequence email) {
    this.userId = userId;
    this.name = name;
    this.email = email;
  }
   ...
   */
  public static com.kika.avro.UserCreatedEvent.Builder newBuilder() {
    return new com.kika.avro.UserCreatedEvent.Builder();
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.kika.avro.UserCreatedEvent.Builder newBuilder(com.kika.avro.UserCreatedEvent.Builder other) {
    if (other == null) {
      return new com.kika.avro.UserCreatedEvent.Builder();
    } else {
      return new com.kika.avro.UserCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.kika.avro.UserCreatedEvent.Builder newBuilder(com.kika.avro.UserCreatedEvent other) {
    if (other == null) {
      return new com.kika.avro.UserCreatedEvent.Builder();
    } else {
      return new com.kika.avro.UserCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kika.avro.UserCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kika.avro.UserCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kika.avro.UserCreatedEvent.Builder setUserId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kika.avro.UserCreatedEvent.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kika.avro.UserCreatedEvent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kika.avro.UserCreatedEvent.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kika.avro.UserCreatedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kika.avro.UserCreatedEvent.Builder clearEmail() {
      email = null;
